...
# Non-zero LASSO coefficients = selected genes
glmnet_coeffs = predict(glmnet_model, type = "coefficients", s = glmnet_model$lambda.min)

top_glmnet = data.frame(as.matrix(glmnet_coeffs)) %>%
